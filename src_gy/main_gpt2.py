...
from pytorch_pretrained_bert import BertAdam, GPT2Tokenizer, OpenAIAdam
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        text = torch.LongTensor(convert_one_line(text, max_seq_length=220, tokenizer=self._tokenizer, split_point=self._split_point))
