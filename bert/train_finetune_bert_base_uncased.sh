python main_bert.py train_all name_for_fbertbumodel --batch-size 48 --lr 0.00005 --step 3 --kloss 0.02 --lr_layerdecay 0.98 --model mybert_base_uncased --split_point 0.25 --fold_name /folds_weight1.5.pkl --bsample True
